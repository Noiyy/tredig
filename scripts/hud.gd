...
@onready var left_bonus1: Control           = $LeftPlayerHUD/HBoxContainer/Bonus1
@onready var right_bonus1: Control          = $RightPlayerHUD/HBoxContainer/Bonus1
@onready var left_bonus_icon1: TextureRect  = $LeftPlayerHUD/HBoxContainer/Bonus1/BonusIcon
@onready var right_bonus_icon1: TextureRect = $RightPlayerHUD/HBoxContainer/Bonus1/BonusIcon
@onready var left_bonus_timer1: TextureProgressBar  = $LeftPlayerHUD/HBoxContainer/Bonus1/BonusTimerBar
@onready var right_bonus_timer1: TextureProgressBar = $RightPlayerHUD/HBoxContainer/Bonus1/BonusTimerBar
@onready var left_bonus_label1: Label       = $LeftPlayerHUD/HBoxContainer/Bonus1/Label
@onready var left_bonus_label2: Label       = $LeftPlayerHUD/HBoxContainer/Bonus2/Label
@onready var left_bonus2: Control           = $LeftPlayerHUD/HBoxContainer/Bonus2
@onready var right_bonus2: Control          = $RightPlayerHUD/HBoxContainer/Bonus2
@onready var left_bonus_icon2: TextureRect  = $LeftPlayerHUD/HBoxContainer/Bonus2/BonusIcon
@onready var right_bonus_icon2: TextureRect = $RightPlayerHUD/HBoxContainer/Bonus2/BonusIcon
@onready var left_bonus_timer2: TextureProgressBar  = $LeftPlayerHUD/HBoxContainer/Bonus2/BonusTimerBar
@onready var right_bonus_timer2: TextureProgressBar = $RightPlayerHUD/HBoxContainer/Bonus2/BonusTimerBar
